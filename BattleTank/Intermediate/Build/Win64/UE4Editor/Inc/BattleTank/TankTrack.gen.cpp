...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTankTrack_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTankTrack_SetThrottle, "SetThrottle" }, // 66171215
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTankTrack_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/TankTrack.h" },
		{ "ToolTip", "Tank Track is used to set maximum driving force, and apply forces to the tank" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UTankTrack, 1277143780);
